...
class JohnTaskProcessor(DataProcessor):
    """Processor for the News data set (GLUE version)."""

    def __init__(self):
        self.labels = ['technology', 'game', 'fashion', 'houseliving']
...
def main(_):
  ...
  if FLAGS.do_train:
    ...
    print('train_examples -> {}'.format(train_examples))
    print('train_batch_size -> {}'.format(FLAGS.train_batch_size))
    print('train_epochs -> {}'.format(FLAGS.num_train_epochs))
    num_train_steps = int(
